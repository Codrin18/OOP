...
public:
	...
	void updateSongInRepo(const string& oldArtist, const string& oldTitle, const string& artist, const string& title, const double minutes, const double seconds, const string& source);
